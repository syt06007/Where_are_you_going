    ...
    while True:
        ...
        if len(decoded_info) == 1:
            if len(decoded_info[0])!=0:
                ...
                print('im current_position:',current_position)
...
def output_thread(output_queue):
    ...
    while True:
        ...
        if prev_dir == dir:
            ...
            elif dir[0] < 0: # forward / 1times long
                print('Go Straight')
                GPIO.output(BUZZER_PIN, GPIO.HIGH)
                time.sleep(2)
                GPIO.output(BUZZER_PIN, GPIO.LOW)
            ...
            else: # dir[0] > 0 / backward
                    print('SET INSTRUCTION 04')
